...
This subproject contains the cleaned research implementation accompanying
...
This is one of several subprojects in the repository; the top-level
[`README.md`](../README.md) indexes the others.  Everything under this
directory accompanies the Helmholtz manuscript alone.
...
Five documents sit at the top level of this subproject.  `README.md` (this file) explains how to
...
Run commands from this directory, the top level of the subproject.
...
The other manuscripts in this repository are cited in the top-level
[`README.md`](../README.md) and in [`CITATION.txt`](../CITATION.txt).
