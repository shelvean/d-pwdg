...
k=16.0; a=0.5; R=1.0; ne=8; alpha=beta=delta=0.5; h=0.44; rc=0.75; tau=1e-12; NdtN=70
plist=[9,15,21,27,33,37,41,49,57,65,73,81,89,97]
...
for p in plist:
    ...
    out=Path(__file__).resolve().parent.parent/'data'/'highp_global_dtn_pwdg_reproduced.csv'
